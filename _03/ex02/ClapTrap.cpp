...
{  
    std::cout << "Copy Constructor called in Clap Trap" << std::endl;
	*this = src;
	return ;
}
...
{
    std::cout << "Operator overload called in Clap Trap" << std::endl;
...
{
    std::cout << "Destructor called in Clap Trap" << std::endl;
}
